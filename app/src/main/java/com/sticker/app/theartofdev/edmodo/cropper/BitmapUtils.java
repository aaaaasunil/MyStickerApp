...
final class BitmapUtils {
    ...
    static Uri writeTempStateStoreBitmap(Context context, Bitmap bitmap, Uri uri) throws FileNotFoundException {
        boolean z = true;
        if (uri == null) {
            try {
    ...
    private static BitmapSampled cropBitmap(Context r14, Uri r15, float[] r16, int r17, int r18, int r19, boolean r20, int r21, int r22, int r23, int r24, boolean r25, boolean r26, int r27) {
        /*
            r0 = r17
            r1 = r16
            r2 = r18
        ...
        L_0x0026:
            ...
            r6 = r11
            r7 = r27
            com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled r2 = decodeSampledBitmapRegion(r2, r3, r4, r5, r6, r7)     // Catch:{ Exception -> 0x0037 }
            android.graphics.Bitmap r1 = r2.bitmap     // Catch:{ Exception -> 0x0037 }
            int r8 = r2.sampleSize     // Catch:{ Exception -> 0x0037 }
        L_0x0037:
            if (r1 == 0) goto L_0x0065
            r12 = r25
            r13 = r26
            android.graphics.Bitmap r10 = rotateAndFlipBitmapInt(r1, r0, r12, r13)     // Catch:{ OutOfMemoryError -> 0x005d }
            int r1 = r0 % 90
            ...
            r6 = r21
            r7 = r22
            android.graphics.Bitmap r10 = cropForRotatedImage(r1, r2, r3, r4, r5, r6, r7)     // Catch:{ OutOfMemoryError -> 0x005b }
        L_0x0055:
            com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled r0 = new com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled
            r0.<init>(r10, r8)
            return r0
        L_0x005b:
            r0 = move-exception
        ...
        L_0x0065:
            ...
            r7 = r22
            r8 = r27
            com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled r0 = cropBitmap((android.content.Context) r1, (android.net.Uri) r2, (float[]) r3, (int) r4, (boolean) r5, (int) r6, (int) r7, (int) r8, (android.graphics.Rect) r9, (int) r10, (int) r11, (boolean) r12, (boolean) r13)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils.cropBitmap(android.content.Context, android.net.Uri, float[], int, int, int, boolean, int, int, int, int, boolean, boolean, int):com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static Bitmap decodeImage(ContentResolver r2, Uri r3, BitmapFactory.Options r4) throws FileNotFoundException {
        /*
        L_0x0000:
            r0 = 0
        ...
        L_0x0038:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils.decodeImage(android.content.ContentResolver, android.net.Uri, android.graphics.BitmapFactory$Options):android.graphics.Bitmap");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static BitmapSampled decodeSampledBitmapRegion(Context r4, Uri r5, Rect r6, int r7, int r8, int r9) {
        /*
            r0 = 0
        ...
        L_0x0023:
            com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled r8 = new com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled     // Catch:{ OutOfMemoryError -> 0x003b }
        ...
        L_0x003b:
            ...
            r7.recycle()
        L_0x004f:
            com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled r4 = new com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled
            r5 = 1
            r4.<init>(r0, r5)
            return r4
        L_0x0056:
        ...
        L_0x008f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils.decodeSampledBitmapRegion(android.content.Context, android.net.Uri, android.graphics.Rect, int, int, int):com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled");
    }
