...
import com.sticker.app.theartofdev.edmodo.cropper.BitmapCroppingWorkerTask;
import com.sticker.app.theartofdev.edmodo.cropper.BitmapLoadingWorkerTask;
import com.sticker.app.theartofdev.edmodo.cropper.BitmapUtils;
...
public class CropImageView extends FrameLayout {
    ...
    public CropImageView(Context r6, AttributeSet r7) {
        super(r6,r7);
        /*
            r5 = this;
            r5.<init>(r6, r7)
        ...
        L_0x0039:
            ...
            r3 = r2
            com.sticker.app.theartofdev.edmodo.cropper.CropImageOptions r3 = (com.sticker.app.theartofdev.edmodo.cropper.CropImageOptions) r3
        L_0x004c:
            if (r3 != 0) goto L_0x01f2
            com.sticker.app.theartofdev.edmodo.cropper.CropImageOptions r3 = new com.sticker.app.theartofdev.edmodo.cropper.CropImageOptions
            r3.<init>()
            if (r7 == 0) goto L_0x01f2
            int[] r2 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView
            android.content.res.TypedArray r7 = r6.obtainStyledAttributes(r7, r2, r0, r0)
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropFixAspectRatio     // Catch:{ all -> 0x01ed }
            ...
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropAspectRatioX     // Catch:{ all -> 0x01ed }
            int r2 = r3.aspectRatioX     // Catch:{ all -> 0x01ed }
            int r0 = r7.getInteger(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.aspectRatioX = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropAspectRatioY     // Catch:{ all -> 0x01ed }
            int r2 = r3.aspectRatioY     // Catch:{ all -> 0x01ed }
            int r0 = r7.getInteger(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.aspectRatioY = r0     // Catch:{ all -> 0x01ed }
            com.sticker.app.theartofdev.edmodo.cropper.CropImageView$ScaleType[] r0 = com.sticker.app.theartofdev.edmodo.cropper.CropImageView.ScaleType.values()     // Catch:{ all -> 0x01ed }
            int r2 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropScaleType     // Catch:{ all -> 0x01ed }
            com.sticker.app.theartofdev.edmodo.cropper.CropImageView$ScaleType r4 = r3.scaleType     // Catch:{ all -> 0x01ed }
            ...
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropAutoZoomEnabled     // Catch:{ all -> 0x01ed }
            boolean r2 = r3.autoZoomEnabled     // Catch:{ all -> 0x01ed }
            boolean r0 = r7.getBoolean(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.autoZoomEnabled = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropMultiTouchEnabled     // Catch:{ all -> 0x01ed }
            boolean r2 = r3.multiTouchEnabled     // Catch:{ all -> 0x01ed }
            boolean r0 = r7.getBoolean(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.multiTouchEnabled = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropMaxZoom     // Catch:{ all -> 0x01ed }
            int r2 = r3.maxZoom     // Catch:{ all -> 0x01ed }
            int r0 = r7.getInteger(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.maxZoom = r0     // Catch:{ all -> 0x01ed }
            com.sticker.app.theartofdev.edmodo.cropper.CropImageView$CropShape[] r0 = com.sticker.app.theartofdev.edmodo.cropper.CropImageView.CropShape.values()     // Catch:{ all -> 0x01ed }
            int r2 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropShape     // Catch:{ all -> 0x01ed }
            com.sticker.app.theartofdev.edmodo.cropper.CropImageView$CropShape r4 = r3.cropShape     // Catch:{ all -> 0x01ed }
            int r4 = r4.ordinal()     // Catch:{ all -> 0x01ed }
            int r2 = r7.getInt(r2, r4)     // Catch:{ all -> 0x01ed }
            r0 = r0[r2]     // Catch:{ all -> 0x01ed }
            r3.cropShape = r0     // Catch:{ all -> 0x01ed }
            com.sticker.app.theartofdev.edmodo.cropper.CropImageView$Guidelines[] r0 = com.sticker.app.theartofdev.edmodo.cropper.CropImageView.Guidelines.values()     // Catch:{ all -> 0x01ed }
            int r2 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropGuidelines     // Catch:{ all -> 0x01ed }
            com.sticker.app.theartofdev.edmodo.cropper.CropImageView$Guidelines r4 = r3.guidelines     // Catch:{ all -> 0x01ed }
            int r4 = r4.ordinal()     // Catch:{ all -> 0x01ed }
            int r2 = r7.getInt(r2, r4)     // Catch:{ all -> 0x01ed }
            r0 = r0[r2]     // Catch:{ all -> 0x01ed }
            r3.guidelines = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropSnapRadius     // Catch:{ all -> 0x01ed }
            float r2 = r3.snapRadius     // Catch:{ all -> 0x01ed }
            float r0 = r7.getDimension(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.snapRadius = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropTouchRadius     // Catch:{ all -> 0x01ed }
            float r2 = r3.touchRadius     // Catch:{ all -> 0x01ed }
            float r0 = r7.getDimension(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.touchRadius = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropInitialCropWindowPaddingRatio     // Catch:{ all -> 0x01ed }
            ...
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropBorderLineThickness     // Catch:{ all -> 0x01ed }
            float r2 = r3.borderLineThickness     // Catch:{ all -> 0x01ed }
            float r0 = r7.getDimension(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.borderLineThickness = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropBorderLineColor     // Catch:{ all -> 0x01ed }
            int r2 = r3.borderLineColor     // Catch:{ all -> 0x01ed }
            int r0 = r7.getInteger(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.borderLineColor = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropBorderCornerThickness     // Catch:{ all -> 0x01ed }
            float r2 = r3.borderCornerThickness     // Catch:{ all -> 0x01ed }
            float r0 = r7.getDimension(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.borderCornerThickness = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropBorderCornerOffset     // Catch:{ all -> 0x01ed }
            float r2 = r3.borderCornerOffset     // Catch:{ all -> 0x01ed }
            float r0 = r7.getDimension(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.borderCornerOffset = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropBorderCornerLength     // Catch:{ all -> 0x01ed }
            float r2 = r3.borderCornerLength     // Catch:{ all -> 0x01ed }
            float r0 = r7.getDimension(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.borderCornerLength = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropBorderCornerColor     // Catch:{ all -> 0x01ed }
            int r2 = r3.borderCornerColor     // Catch:{ all -> 0x01ed }
            int r0 = r7.getInteger(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.borderCornerColor = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropGuidelinesThickness     // Catch:{ all -> 0x01ed }
            float r2 = r3.guidelinesThickness     // Catch:{ all -> 0x01ed }
            float r0 = r7.getDimension(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.guidelinesThickness = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropGuidelinesColor     // Catch:{ all -> 0x01ed }
            int r2 = r3.guidelinesColor     // Catch:{ all -> 0x01ed }
            int r0 = r7.getInteger(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.guidelinesColor = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropBackgroundColor     // Catch:{ all -> 0x01ed }
            int r2 = r3.backgroundColor     // Catch:{ all -> 0x01ed }
            int r0 = r7.getInteger(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.backgroundColor = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropShowCropOverlay     // Catch:{ all -> 0x01ed }
            boolean r2 = r5.mShowCropOverlay     // Catch:{ all -> 0x01ed }
            boolean r0 = r7.getBoolean(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.showCropOverlay = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropShowProgressBar     // Catch:{ all -> 0x01ed }
            ...
            float r0 = r7.getDimension(r0, r2)     // Catch:{ all -> 0x01ed }
            r3.borderCornerThickness = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropMinCropWindowWidth     // Catch:{ all -> 0x01ed }
            ...
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropMinCropWindowHeight     // Catch:{ all -> 0x01ed }
            int r2 = r3.minCropWindowHeight     // Catch:{ all -> 0x01ed }
            float r2 = (float) r2     // Catch:{ all -> 0x01ed }
            float r0 = r7.getDimension(r0, r2)     // Catch:{ all -> 0x01ed }
            int r0 = (int) r0     // Catch:{ all -> 0x01ed }
            r3.minCropWindowHeight = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropMinCropResultWidthPX     // Catch:{ all -> 0x01ed }
            int r2 = r3.minCropResultWidth     // Catch:{ all -> 0x01ed }
            float r2 = (float) r2     // Catch:{ all -> 0x01ed }
            float r0 = r7.getFloat(r0, r2)     // Catch:{ all -> 0x01ed }
            int r0 = (int) r0     // Catch:{ all -> 0x01ed }
            r3.minCropResultWidth = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropMinCropResultHeightPX     // Catch:{ all -> 0x01ed }
            int r2 = r3.minCropResultHeight     // Catch:{ all -> 0x01ed }
            float r2 = (float) r2     // Catch:{ all -> 0x01ed }
            float r0 = r7.getFloat(r0, r2)     // Catch:{ all -> 0x01ed }
            int r0 = (int) r0     // Catch:{ all -> 0x01ed }
            r3.minCropResultHeight = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropMaxCropResultWidthPX     // Catch:{ all -> 0x01ed }
            int r2 = r3.maxCropResultWidth     // Catch:{ all -> 0x01ed }
            float r2 = (float) r2     // Catch:{ all -> 0x01ed }
            float r0 = r7.getFloat(r0, r2)     // Catch:{ all -> 0x01ed }
            int r0 = (int) r0     // Catch:{ all -> 0x01ed }
            r3.maxCropResultWidth = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropMaxCropResultHeightPX     // Catch:{ all -> 0x01ed }
            int r2 = r3.maxCropResultHeight     // Catch:{ all -> 0x01ed }
            float r2 = (float) r2     // Catch:{ all -> 0x01ed }
            float r0 = r7.getFloat(r0, r2)     // Catch:{ all -> 0x01ed }
            int r0 = (int) r0     // Catch:{ all -> 0x01ed }
            r3.maxCropResultHeight = r0     // Catch:{ all -> 0x01ed }
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropFlipHorizontally     // Catch:{ all -> 0x01ed }
            ...
            int r0 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.styleable.CropImageView_cropSaveBitmapToInstanceState     // Catch:{ all -> 0x01ed }
        ...
        L_0x01f2:
            r3.validate()
            com.sticker.app.theartofdev.edmodo.cropper.CropImageView$ScaleType r7 = r3.scaleType
            r5.mScaleType = r7
            ...
            int r7 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.layout.crop_image_view
            android.view.View r6 = r6.inflate(r7, r5, r1)
            int r7 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.C1060id.ImageView_image
            ...
            r7.setScaleType(r0)
            int r7 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.C1060id.CropOverlayView
            android.view.View r7 = r6.findViewById(r7)
            com.sticker.app.theartofdev.edmodo.cropper.CropOverlayView r7 = (com.sticker.app.theartofdev.edmodo.cropper.CropOverlayView) r7
            r5.mCropOverlayView = r7
            com.sticker.app.theartofdev.edmodo.cropper.CropOverlayView r7 = r5.mCropOverlayView
            com.sticker.app.theartofdev.edmodo.cropper.CropImageView$1 r0 = new com.sticker.app.theartofdev.edmodo.cropper.CropImageView$1
            r0.<init>()
            r7.setCropWindowChangeListener(r0)
            com.sticker.app.theartofdev.edmodo.cropper.CropOverlayView r7 = r5.mCropOverlayView
            r7.setInitialAttributeValues(r3)
            int r7 = com.sticker.app.theartofdev.edmodo.cropper.C1058R.C1060id.CropProgressBar
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sticker.app.theartofdev.edmodo.cropper.CropImageView.<init>(android.content.Context, android.util.AttributeSet):void");
    }
...
//                BitmapCroppingWorkerTask bitmapCroppingWorkerTask4 = r0;
    ...
    public void handleCropWindowChanged(boolean r12, boolean r13) {
        /*
            ...
            com.sticker.app.theartofdev.edmodo.cropper.CropOverlayView r2 = r11.mCropOverlayView
        ...
        L_0x00cf:
            ...
            com.sticker.app.theartofdev.edmodo.cropper.CropImageAnimation r3 = r11.mAnimation
            if (r3 != 0) goto L_0x00ea
            com.sticker.app.theartofdev.edmodo.cropper.CropImageAnimation r3 = new com.sticker.app.theartofdev.edmodo.cropper.CropImageAnimation
            android.widget.ImageView r4 = r11.mImageView
            com.sticker.app.theartofdev.edmodo.cropper.CropOverlayView r5 = r11.mCropOverlayView
            r3.<init>(r4, r5)
            r11.mAnimation = r3
        L_0x00ea:
            com.sticker.app.theartofdev.edmodo.cropper.CropImageAnimation r3 = r11.mAnimation
        ...
        L_0x00fb:
            com.sticker.app.theartofdev.edmodo.cropper.CropImageView$OnSetCropWindowChangeListener r13 = r11.mOnSetCropWindowChangeListener
        ...
        L_0x0104:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sticker.app.theartofdev.edmodo.cropper.CropImageView.handleCropWindowChanged(boolean, boolean):void");
    }
    ...
    private void setCropOverlayVisibility() {
        CropOverlayView cropOverlayView = this.mCropOverlayView;
        if (cropOverlayView != null) {
            cropOverlayView.setVisibility((!this.mShowCropOverlay || this.mBitmap == null) ? View.INVISIBLE : View.VISIBLE);
        }
    }
